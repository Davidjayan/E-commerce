  ...
  <style type="text/css">
   ...
   footer{
    ...
    <body>
        ...
        <nav id="myHeader">
            ...
            <div class="col2">
                ...
                <input type="number" min="1" max="5" id="numval<?php echo $product_array[$_GET['variable']]["id"];?>" name="quantity" oninput="mssgAppear()">
    ...
    <div id="contactus" class="fcol1">
        ...
        <div class="appear" id="apm"><a onclick="mssgDisappear()"class="x"><b><i class="fas fa-times-circle"></i></b></a><b>Please Login first!</b></div>         
